...
public class UnsortedLinkedListPriorityQueueTest {
    ...
    public PriorityQueue<Person> instance = new UnsortedLinkedListPriorityQueue<>();
    ...
    // testing adding an item to a queue of 1 item
    @Test
    public void testAdd2() {

        System.out.println("testing adding an item to a queue of 1 item");
        ...
        String result = instance.toString();
        String expResult = "(person2, 3), (person1, 5)";
    ...
    // test removing an item from the start of a queue with 2 items in it
    @Test
    public void testRemove2() {

        System.out.println("test removing an item from the start of a queue with 2 items in it");
        ...
        String result = instance.toString();
        String expResult = "(person1, 3)";

        assertEquals(expResult, result);
    }

    // test removing an item from the middle of a queue with 3 items in it
    @Test
    public void testRemove3() {

        System.out.println("test removing an item from the middle of a queue with 3 items in it");
        ...
        String result = instance.toString();
        String expResult = "(person3, 3), (person1, 4)";
